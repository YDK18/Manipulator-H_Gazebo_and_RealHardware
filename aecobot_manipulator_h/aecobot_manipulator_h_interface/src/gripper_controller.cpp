...
#include "aecobot_manipulator_h_interface/gripper_controller.h"
...
void GripperController::initPublisher(bool using_gazebo)
{
  ...
  gripper_state_pub_ = nh_.advertise<aecobot_manipulator_h_msgs::State>(robot_name_ + "/gripper_state", 10);
}
...
bool GripperController::setGripperPositionMsgCallback(aecobot_manipulator_h_msgs::SetJointPosition::Request &req,
...
bool GripperController::calcPlannedPath(aecobot_manipulator_h_msgs::JointPosition msg)
{
...
{
  aecobot_manipulator_h_msgs::JointPosition joint_msg;
