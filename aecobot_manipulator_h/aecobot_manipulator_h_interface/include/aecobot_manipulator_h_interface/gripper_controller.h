...
#ifndef AECOBOT_MANIPULATOR_H_GRIPPER_CONTROLLER_H
#define AECOBOT_MANIPULATOR_H_GRIPPER_CONTROLLER_H
...
class GripperController
{
 ...
 private:
  ...
  bool setGripperPositionMsgCallback(aecobot_manipulator_h_msgs::SetJointPosition::Request &req,
...
#endif /*AECOBOT_MANIPULATOR_H_GRIPPER_CONTROLLER_H*/
