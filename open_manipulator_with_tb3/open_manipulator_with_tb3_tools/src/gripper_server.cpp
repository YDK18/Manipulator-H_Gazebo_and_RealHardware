...
/*ros::Publisher platform_joint6_pub_, gazebo_joint6_pub_;
ros::ServiceServer joint6_server_;*/

bool gripperCallback(open_manipulator_msgs::SetJointPosition::Request  &req,
//bool joint6Callback(open_manipulator_msgs::SetJointPosition::Request  &req,
...
/*  gazebo_joint6_pub_.publish(position);
  platform_joint6_pub_.publish(position_array);*/
...
{
/*  platform_joint6_pub_ = nh.advertise<std_msgs::Float64MultiArray>("joint_position", 10);
  gazebo_joint6_pub_ = nh.advertise<std_msgs::Float64>("joint_position/command", 10);*/
...
{  
//  joint6_server_ = nh.advertiseService("joint6", joint6Callback);
...
//  ros::init(argc, argv, "joint6_server");
